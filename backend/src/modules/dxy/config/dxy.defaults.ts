...
export const DXY_DEFAULTS_BY_FOCUS: Record<DxyFocus, Omit<DxyCoreConfig, "focus">> = {
  ...
  "90d":  { windowLen: 600, threshold: 0.03, topK: 10, weightMode: "W2" },
  "180d": { windowLen: 600, threshold: 0.03, topK: 10, weightMode: "W2" },
  "365d": { windowLen: 600, threshold: 0.03, topK: 10, weightMode: "W2" },
};
